...
export default function Admin() {
  ...
  return (<MC.Container>
    <MC.Box className={classes.root} width={ "fit-content" } 
    ...
    >
      <MC.AppBar position="static"> 
        <MC.Tabs value={value} onChange={handleChange} aria-label="simple tabs example">
          <MC.Tab label="Add new user" {...a11yProps(0)} />
          <MC.Tab label="Search for a user" {...a11yProps(1)} />
          <MC.Tab disabled label="Add new subject" {...a11yProps(2)} />
        </MC.Tabs>
      </MC.AppBar>
