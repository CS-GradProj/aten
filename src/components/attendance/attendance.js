...
function Attendance() {
  ...
  return (
    <>
      <m.TableContainer>
        <m.Table>
          <m.TableHead stickyHeader aria-label="sticky table" > <h1> {Subject_name} </h1> </m.TableHead>
            <m.TableRow>
      ...
      <l.Pagination style={{display: "block", margin: "10px auto"}} count={3} color="primary" />
    </>
  );
}
